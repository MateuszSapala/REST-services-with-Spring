...
public class OrderController {
    ...
    CollectionModel<EntityModel<Order>> getAllOrders(){
        ...
        return CollectionModel.of(orders, WebMvcLinkBuilder.linkTo(WebMvcLinkBuilder.methodOn(OrderController.class).getAllOrders()).withSelfRel());
    }
    ...
    ResponseEntity<EntityModel<Order>> newOrder(@RequestBody Order order){
        ...
        return ResponseEntity.created(
                WebMvcLinkBuilder.linkTo(WebMvcLinkBuilder.methodOn(OrderController.class).getOne(newOrder.getId())).toUri())
